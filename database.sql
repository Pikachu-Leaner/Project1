...
-- Tắt kiểm tra khóa ngoại tạm thời để có thể xóa/sửa bảng an toàn
...
-- 4. Tạo bảng Đơn hàng (Orders) - MỚI
...
-- 5. Tạo bảng Chi tiết Đơn hàng (Order Details) - MỚI
CREATE TABLE IF NOT EXISTS order_details (
    id INT AUTO_INCREMENT PRIMARY KEY,
    order_id INT NOT NULL,
    product_id INT NOT NULL,
    quantity INT NOT NULL,
    price INT NOT NULL, -- Lưu lại giá tại đúng thời điểm khách chốt mua hàng
...
-- 7. Thêm sản phẩm mẫu (category_id = 1 là 'Điện thoại')
